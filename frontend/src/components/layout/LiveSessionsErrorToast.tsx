...
export function LiveSessionsErrorToast() {
  ...
  return (
    <div
      role="alert"
      className="sticky top-16 z-[31] flex w-full min-w-0 items-start gap-2 border-b border-amber-500/35 bg-amber-500/15 px-3 py-2 text-start shadow-sm sm:px-4 md:px-6"
    >
      <AlertTriangle
